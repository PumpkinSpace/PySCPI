...
SCPI_Data = {
    ...
    'PIM:TEL? 0,ascii':   [wflag_size + time_size + chksum_size + 8,             'ascii'],
    ...
    'PIM:TEL? 1,ascii':   [wflag_size + time_size + chksum_size + 8,             'ascii'],
    ...
    'PIM:TEL? 2,ascii':   [wflag_size + time_size + chksum_size + 8,             'ascii'],   
    ...
    'PIM:TEL? 3,ascii':   [wflag_size + time_size + chksum_size + 32,            'ascii'],  
    ...
    'PIM:TEL? 4,ascii':   [wflag_size + time_size + chksum_size + 32,            'ascii'],    
    ...
    'PIM:TEL? 5,ascii':   [wflag_size + time_size + chksum_size + 1,             'ascii'],
    ...
    'PIM:TEL? 6,ascii':   [wflag_size + time_size + chksum_size + 8,             'ascii']    
    }
