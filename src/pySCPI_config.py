...
SCPI_Data = {
    ...
    'SUP:TEL? 0,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'SUP:TEL? 1,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'SUP:TEL? 2,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'SUP:TEL? 3,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'SUP:TEL? 4,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'SUP:TEL? 5,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'SUP:TEL? 6,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'SUP:TEL? 7,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'SUP:TEL? 8,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'GPS:TEL? 2,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'PIM:TEL? 0,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'PIM:TEL? 1,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'PIM:TEL? 2,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'PIM:TEL? 3,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'PIM:TEL? 4,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'PIM:TEL? 5,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'PIM:TEL? 6,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BSM:TEL? 0,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BSM:TEL? 1,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BSM:TEL? 2,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BSM:TEL? 3,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BSM:TEL? 4,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BSM:TEL? 5,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BSM:TEL? 6,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BSM:TEL? 7,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BSM:TEL? 8,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BSM:TEL? 9,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BSM:TEL? 10,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 8,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 9,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 10,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 11,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 13,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 14,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 15,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 16,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 17,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 18,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 19,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 20,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 21,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 22,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 23,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 24,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 25,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 48,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 49,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 50,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 51,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 52,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 53,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 54,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 55,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 56,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 57,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 58,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 60,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 61,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 62,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 63,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 80,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 81,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 82,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 83,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 84,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 85,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 90,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 93,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 94,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 95,length': [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 104,length':[wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 105,length':[wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 106,length':[wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 107,length':[wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BM2:TEL? 114,length':[wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BIM:TEL? 0,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BIM:TEL? 1,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BIM:TEL? 2,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
    ...
    'BIM:TEL? 3,length':  [wflag_size + time_size + length_size + chksum_size,   'uint'],
